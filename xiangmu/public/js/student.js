...
exports.rem = function(req,res){
	 ...
	 var id = req.body.id;
    UserStu.findByIdAndRemove(id, function(err, result){
        if (err) {
            console.log("Error:" + err);
        }
        else {
            res.json({message:{code:100}})
        }
        return;
    })
...
exports.update = function(req,res){
    var id = req.body.id;
    var arr = [{StuClass:req.body.StuClass},{StuKC:req.body.StuKC},{StuXH:req.body.StuXH},
		{StuName:req.body.StuName},{StuScore:req.body.StuScore},{}]
    var i = 0;
    while(i<arr.length){
        (function(a){
